...
LABEL_SMOOTHING = 0.0
PATIENCE = 8
PLOT_DIR = "plots_malaria_exp"
RESULT_JSON = "results_malaria_exp.json"
CKPT_PATH = "checkpoint_malaria_vit_best.pt"
...
def main():
    ...
    print("Loaded:", NPZ_PATH, "N:", len(x_all), "x.dtype:", x_all.dtype, "y.shape:", y_all.shape)
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        print(
            ...
            f"val_f1={val_metrics['f1']:.4f} lr={history['lr'][-1]:.6f} "
    ...
    plot_two_curves(history["loss"], history["val_loss"], "loss", "Malaria Train vs Val Loss", "malaria_loss.png")
    plot_two_curves(history["acc"], history["val_acc"], "acc", "Malaria Train vs Val Accuracy", "malaria_accuracy.png")
    plot_one_curve(history["val_f1"], "val_f1", "Malaria Validation F1", "malaria_val_f1.png")
    plot_one_curve(history["lr"], "lr", "Malaria Learning Rate", "malaria_lr.png")
